...
const descriptionText = `We have raised $${totalRaised.toLocaleString()} for ${GAMES_JSON.length} games. There ${unfundedGames === 1 ? 'is': 'are'} currently ${unfundedGames} ${unfundedGames === 1 ? 'game' : 'games'} still unfunded.`;
